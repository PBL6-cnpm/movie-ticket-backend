export enum PermissionName {
  ...
  ACCOUNT_CREATE_ADMIN = 'account_create_admin',
  ACCOUNT_UPDATE_ADMIN = 'account_update_admin',
  ACCOUNT_READ_ADMIN = 'account_read_admin',
  ...
  ACCOUNT_READ_USER = 'account_read_user',
  ACCOUNT_DISABLE_USER = 'account_disable_user',
